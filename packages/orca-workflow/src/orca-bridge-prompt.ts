...
export function renderOrcaLeadSystemPrompt(initialWorker?: OrcaInitialWorkerRef | null): string {
  const lines = [
    ...
    '- After create_worker, create_workers, or send_to_worker returns, your turn is OVER. Produce ZERO output — no summary, no confirmation, no "I\'ve sent...", no "waiting...", nothing.',
