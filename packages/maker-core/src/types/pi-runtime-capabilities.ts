...
export interface PiRuntimeCapabilityManifest {
  ...
  /** Commands whose get_commands provenance resolves to this session's explicit project Skill/prompt/extension paths. */
  explicitProjectCommandNames?: readonly string[];
