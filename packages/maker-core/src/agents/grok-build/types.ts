...
export interface AcpInitializeResult {
  ...
  /**
   * grok 1.0.13 always advertises authMethods even when ~/.grok/auth.json already
   * has a token. `defaultAuthMethodId: "cached_token"` means that cached login
   * is the active method — not "please sign in".
   */
  _meta?: {
