...
apps. The first supported harnesses are **Claude Code**, **Codex**, and **Pi**. **Grok Build** is a fourth Cindy-hosted harness (same loop as Pi) when SuperGrok (xAI) is connected. Models and harnesses mix
