...
export default {
  ...
  entries: [
    ...
    { id: 'imBot.cindy.slack', isVisible: (identity) => identity.mode === 'cloud' && showCindyGroup(identity), tab: 'im-bot', targetId: 'cindy-im-slack', titleKey: 'settings.remoteControl.sections.hook', sectionKey: 'settings.imBot.groups.cindy', aliases: ['Slack', 'Slack bot', 'IM'] },
    { id: 'imBot.cindy.telegram', isVisible: (identity) => identity.mode === 'cloud' && showCindyGroup(identity), tab: 'im-bot', targetId: 'cindy-im-telegram', titleKey: 'settings.tina.prefs.providerTelegram', sectionKey: 'settings.imBot.groups.cindy', descriptionKey: 'settings.remoteControl.hook.telegram.description', aliases: ['Telegram', 'Telegram bot'] },
    { id: 'imBot.cindy.x', isVisible: (identity) => identity.mode === 'cloud' && showCindyGroup(identity), tab: 'im-bot', targetId: 'cindy-im-x', titleKey: 'settings.tina.prefs.providerX', sectionKey: 'settings.imBot.groups.cindy', descriptionKey: 'settings.remoteControl.hook.x.description', aliases: ['X', 'Twitter'] },
