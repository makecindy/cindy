...
interface ElectronAPI {
  ...
  maker: {
    ...
    memoryGet: (agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code') => Promise<{
      enabled: boolean;
    ...
    memoryReset: (agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code') => Promise<{
    ...
    auth: {
      getState: (agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code') => Promise<CodexAuthState>;
      triggerLogin: (
        agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code',
      ...
      onStateChanged: (
        cb: (s: { agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code' } & CodexAuthState) => void,
      ) => () => void;
      onLoginProgress: (
        cb: (p: {
          agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code';
    ...
    agent: {
      getStatus: (agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code') => Promise<{
        binaryReady: boolean;
        binaryPath: string;
        authReady: boolean;
        identity?: string;
      ...
      getBinaryVersion: (agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code') => Promise<{
    ...
    usage: {
      getToday: (agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code') => Promise<{
        day: string;
        money?: import('../shared/regionalMoney').RegionalMoney;
        costUsd?: number;
        totalTokens?: number;
      ...
      getAccount: (agentKind: 'claude-code' | 'codex' | 'pi' | 'kimi-code') => Promise<unknown | null>;
