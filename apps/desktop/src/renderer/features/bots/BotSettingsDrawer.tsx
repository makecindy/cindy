    ...
    <Dialog.Root open={open} onOpenChange={(next) => !next && close()}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className="fixed inset-y-0 right-0 z-[51] flex w-full flex-col border-l border-[var(--border-default)] bg-[var(--surface)] outline-none sm:w-[min(640px,70vw)] lg:w-1/2 lg:max-w-[720px]"
        >
