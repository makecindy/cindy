...
import { appendPluginAuthorizationPrompt } from '../plugin-oauth/prompt.js';
...
export function buildDesktopClaudeRuntimeConfig(endpointFn: () => string): AgentRuntimeConfig {
  ...
  const config: AgentRuntimeConfig = {
    ...
    get systemPrompt() {
      return appendPluginAuthorizationPrompt(composeHostPrompt(claudeSystemPrompt));
    },
...
export const desktopCodexRuntimeConfig: AgentRuntimeConfig = {
  ...
  get systemPrompt() {
    return appendPluginAuthorizationPrompt(composeHostPrompt(codexSystemPrompt));
  },
