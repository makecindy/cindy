...
import { assertSharedTaskMedia } from '../sessionMeetingMediaAccess.js';
import type { SessionMeetingPeerCapture } from '../sessionMeetingDispatch.js';
let current = true;
const capture: SessionMeetingPeerCapture = {
  author: { meetingId: 'shared', sessionId: 'task', memberId: 'm', accountId: 'u', displayName: 'Guest' },
