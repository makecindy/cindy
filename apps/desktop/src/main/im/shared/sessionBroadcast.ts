 ...
 * 创建通知统一走 emitSessionCreated：先隔开 sessions:list 写前 flight，
 * 再 tap 给 device-link 控制端，本机窗口同样即时出现。
 */
...
import { noteSessionListMembershipPatch } from '../../localDb/ipc/sessionListSingleFlight';
