...
/**
 * 群成员(非 owner)触发轮次的 per-turn 收紧(D1/D2, 2026-07-30 一群一会话版):
 * 会话是全群共享的, 建行级权限档区分不了发言人 — 改在轮次级强制确认。
 * 读/搜/答自由通过; 破坏性调用与不透明写(file_change / permissions 升权)
 * 强制弹确认卡, 而卡片点击只认 owner — 即"成员能问, 动手要主人拍板"。
 *
