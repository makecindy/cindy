...
export const GIT_REVIEW_INVOKE = {
  GET: IPC_CHANNELS.GIT_REVIEW.GET,
  SUMMARY: IPC_CHANNELS.GIT_REVIEW.SUMMARY,
  COMMITS: IPC_CHANNELS.GIT_REVIEW.COMMITS,
  COMMIT_DIFF: IPC_CHANNELS.GIT_REVIEW.COMMIT_DIFF,
  BRANCH_DIFF: IPC_CHANNELS.GIT_REVIEW.BRANCH_DIFF,
  FILE_DIFF: IPC_CHANNELS.GIT_REVIEW.FILE_DIFF,
  IMAGE_PREVIEW: IPC_CHANNELS.GIT_REVIEW.IMAGE_PREVIEW,
  MARKDOWN_PREVIEW: IPC_CHANNELS.GIT_REVIEW.MARKDOWN_PREVIEW,
  OPEN_FILE: IPC_CHANNELS.GIT_REVIEW.OPEN_FILE,
  STAGE_FILE: IPC_CHANNELS.GIT_REVIEW.STAGE_FILE,
  UNSTAGE_FILE: IPC_CHANNELS.GIT_REVIEW.UNSTAGE_FILE,
  DISCARD_FILE: IPC_CHANNELS.GIT_REVIEW.DISCARD_FILE,
  STAGE_HUNK: IPC_CHANNELS.GIT_REVIEW.STAGE_HUNK,
  UNSTAGE_HUNK: IPC_CHANNELS.GIT_REVIEW.UNSTAGE_HUNK,
  DISCARD_HUNK: IPC_CHANNELS.GIT_REVIEW.DISCARD_HUNK,
  STAGE_ALL: IPC_CHANNELS.GIT_REVIEW.STAGE_ALL,
  UNSTAGE_ALL: IPC_CHANNELS.GIT_REVIEW.UNSTAGE_ALL,
  DISCARD_ALL: IPC_CHANNELS.GIT_REVIEW.DISCARD_ALL,
  COMMIT: IPC_CHANNELS.GIT_REVIEW.COMMIT,
  PUSH: IPC_CHANNELS.GIT_REVIEW.PUSH,
} as const;
