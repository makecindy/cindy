 ...
 */
const dbAgentKindBySession = new Map<string, 'cc' | 'codex' | 'pi' | 'kimi'>();

export function noteSessionAgentKind(sessionId: string, dbAgentKind: 'cc' | 'codex' | 'pi' | 'kimi'): void {
  dbAgentKindBySession.set(sessionId, dbAgentKind);
}

export function getSessionDbAgentKind(sessionId: string): 'cc' | 'codex' | 'pi' | 'kimi' | null {
