...
describe('AgentInputCoordinator Orca priority queue transactions', () => {
  ...
  async function createProvisionalDispatchHarness() {
    ...
    const dispatcher = createOrcaInterAgentDispatcher({
      ...
      rewindPersistedUserMessage: async () => {},
      finalizePersistedUserMessageRewind: async () => {},
      retainPersistedUserMessageCleanup: () => {},
      trackPersistedUserMessageBeforeVendorDispatch: () => {},
      untrackPersistedUserMessageBeforeVendorDispatch: () => {},
      isOrcaTeamActive: async () => true,
      reserveOrcaTeamPreVendorDispatch: () => () => {},
      waitForOrcaTeamTerminalTransition: async () => 'open' as const,
    ...
    const serviceDeps = {
      ...
      reserveTeamDispatchSettlement: (teamId) => dispatcher.reserveTeamDispatchSettlement(teamId),
      waitForOrcaTeamTerminalTransition: async () => 'open' as const,
      resumeWorkerSession: async () => false,
      ...
      reserveWorkerMessage: async (params) => {
        const result = await dispatcher.reserveNextOrcaInterAgentMessage({
          ...
          deferTerminalTransitionRetry: params.deferTerminalTransitionRetry,
...
function makeOrcaItem(
  clientId: string,
  text: string,
  teamId: string): AgentInputQueuedMessage {
