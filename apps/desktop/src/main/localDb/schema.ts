...
export const subagentRuns = sqliteTable(
  'subagent_runs',
  {
    ...
    costQuality: text('cost_quality', { enum: ['actual', 'estimated', 'unavailable'] }),
    costTotalTokens: integer('cost_total_tokens'),
    costInputTokens: integer('cost_input_tokens'),
    costOutputTokens: integer('cost_output_tokens'),
    costCacheReadTokens: integer('cost_cache_read_tokens'),
    costCacheCreateTokens: integer('cost_cache_create_tokens'),
    costAmount: real('cost_amount'),
    costCurrency: text('cost_currency'),
    costApproximate: integer('cost_approximate', { mode: 'boolean' }),
    costFrozenAt: integer('cost_frozen_at'),
